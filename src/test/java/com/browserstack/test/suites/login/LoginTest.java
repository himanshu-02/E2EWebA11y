...
public class LoginTest extends TestBase {
    ...
    // driver.findElement(By.cssSelector("#username input")).sendKeys("locked_user"
    // + Keys.ENTER);
    // driver.findElement(By.cssSelector("#password
    // input")).sendKeys("testingisfun99" + Keys.ENTER);
    // driver.findElement(By.id("login-btn")).click();
    // Assert.assertEquals(driver.findElement(By.className("api-error")).getText(),
    ...
    public void loginSuccess() {
        ...
        options.put("percyCSS",
                ".login_wrapper .Modal_modal__3I0HK .Button_root__24MxS{background-color: " + randomColorBtn + ";}");
        ...
        int criticalIssueCount = Integer
                .parseInt(String.valueOf(((Map) summary.get("issueCountBySeverity")).get("critical")));
    ...
    // driver.findElement(By.id("signin")).click();
    // driver.findElement(By.cssSelector("#username input")).sendKeys("fav_user" +
    // Keys.ENTER);
    // driver.findElement(By.cssSelector("#password input")).sendKeys("wrongpass" +
    // Keys.ENTER);
    // driver.findElement(By.id("login-btn")).click();
    // Assert.assertEquals(driver.findElement(By.className("api-error")).getText(),
    // "Invalid Password");
